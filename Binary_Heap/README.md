...
_** Job ** structure definition (jobID, priority)
...
bash# Compile implementation file
...
bashgcc -Wall -Wextra -std=c99 -o job_scheduler main.c max_heap.c
./job_scheduler
